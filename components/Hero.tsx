  ...
  return (
    <div className='hero bg-zinc-100 h-dvh relative' id='main'>
      ...
      <div className='hero__image-container pt-10 justify-center absolute bottom-0 w-full'>
        ...
        <Image src={images[(currentImage + 1) % 4]} alt='' width={100} height={100}/>
        <Image src={images[(currentImage + 2) % 4]} alt='' width={100} height={100}/>
        <Image src={images[(currentImage + 3) % 4]} alt='' width={100} height={100}/>
        </div>
      </div>
    </div>
  )
